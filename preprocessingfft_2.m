...
%         end
        ...
        EEG = pop_selectevent(EEG_Copy, 'type',str2num(events{1}),'renametype','Standard','deleteevents','on','deleteepochs','on','invertepochs','off');
        EEG = pop_editset(EEG, 'setname',[savename '_fft_Standard']);
        EEG = pop_saveset(EEG, 'filename',[savename '_fft_Standard'],'filepath',[filepath 'segments_fft_JK\']);
